                        ...
                        {selectedFeedback && (
                          <div className="space-y-4">
                            ...
                            <div>
                              ...
                              <p>{selectedFeedback.rating_professionalism}/5</p>
                            </div>
                            <Separator />
                            <div>
                            ...
                            <div>
                              <h4 className="font-medium">
                                Would the candidate recommend this jpb?
                              </h4>
                              <p>
                                {selectedFeedback.suggestions ? "Yes" : "No"}
                              </p>
                            </div>
                            <Separator />
                            <div>
                              <h4 className="font-medium">
                                How the candidate heard about the opportunity
                              </h4>
