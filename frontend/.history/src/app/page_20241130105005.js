          ...
          <DrawerContent>
            ...
            <DrawerFooter className="flex justify-center items-center">
              <DrawerClose asChild>
                <Button
                  variant="outline"
                  className="h-9 w-fit rounded-md px-3  gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-colors  text-muted-foreground hover:text-foreground hover:bg-accent"
                >
                  Cancel
                </Button>
              </DrawerClose>
