  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <footer className="p-4 text-center">
        <Drawer>
          <DrawerTrigger className=" h-9 w-fit rounded-md px-3   text-sm font-medium disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 text-muted-foreground hover:text-foreground hover:bg-accent">
            Admin Access
          </DrawerTrigger>
          <DrawerContent>
            <DrawerHeader>
